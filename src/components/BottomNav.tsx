...
const TABS: { id: TabId; label: string; liveLabel?: string }[] = [
  { id: "roster", label: "Roster", liveLabel: "Squad" },
  { id: "game", label: "Game", liveLabel: "Live" },
  { id: "stats", label: "Stats" },
  { id: "setup", label: "Setup", liveLabel: "Config" },
];
