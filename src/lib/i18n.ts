...
const translations = {
  ...
  "setup.rotationInterval": { en: "Rotation Interval", es: "Intervalo de Rotación" },
  "setup.rotationAuto": { en: "Auto", es: "Auto" },
  "setup.rotationCustom": { en: "Custom", es: "Manual" },
  "setup.minPerRotation": { en: "Min / Rotation", es: "Min / Rotación" },
  "setup.resetToAuto": { en: "↺ Reset to auto-calculated interval", es: "↺ Restablecer intervalo automático" },
  "setup.playtimePreview": { en: "Play Time Preview", es: "Vista Previa de Tiempo" },
  "setup.minPerPlayer": { en: "Min / Player", es: "Min / Jugador" },
  "setup.rotations": { en: "Rotations", es: "Rotaciones" },
  "setup.onBench": { en: "On Bench", es: "En Banca" },
  "setup.playerLabel": { en: "Player", es: "Jugador" },
  "setup.estPlaytime": { en: "Est. Playtime", es: "Tiempo Est." },
  "setup.morePlayers": { en: "more players", es: "jugadores más" },
  "setup.fairnessGood": { en: "✓ Good balance — each player gets 50%+ of game time", es: "✓ Buen balance — cada jugador tiene 50%+ del tiempo" },
  "setup.fairnessOk": { en: "⚠ Moderate — consider shorter rotation intervals", es: "⚠ Moderado — considere intervalos más cortos" },
  "setup.fairnessLow": { en: "⚠ Low playtime — too many players or long intervals", es: "⚠ Poco tiempo — demasiados jugadores o intervalos largos" },
